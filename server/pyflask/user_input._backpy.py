...
class user_input_class:
    ...
    def start_modeling(self,user_input):
        print("in 모델링: ", user_input)
        ...
        model = gensim.models.doc2vec.Doc2Vec(vector_size=30, window=3, min_count=5, epochs=1)
